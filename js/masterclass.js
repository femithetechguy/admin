...
window.renderMasterclassTab = function() {
  setTimeout(() => {
    fetch('json/videos/powerbi_masterclass.json')
      .then(r => r.json())
  ...
  return '<div class="w-full flex justify-center py-4"><span class="text-xl font-bold">Masterclass Playlist</span></div>' +
...
// Duplicate closeNotePopup function removed
