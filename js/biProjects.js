...
window.renderBiProjectsTab = function() {
  setTimeout(() => {
    fetch('json/videos/power_bi_projects_playlist.json')
      .then(r => r.json())
  ...
  return '<div class="w-full flex justify-center py-4"><span class="text-xl font-bold">Bi Projects Playlist</span></div>' +
