// PowerBI Prep tab logic

window.renderPowerBIPrepTab = function(tab) {
  // State for filters
  let filterState = {
    showCategory: false,
    showSkill: false,
  ...
  setTimeout(() => {
    fetch('json/powerbi_prep.json')
      ...
      .catch(() => {
        const container = document.getElementById('powerbi-prep-questions-container');
  ...
  // Initial skeleton
  return `<section id="tab-powerbi-prep" class="tab-content">
    <h3 class="text-xl font-semibold mb-4 flex items-center"><i class="bi bi-lightbulb mr-2"></i> ${tab.name}</h3>
    <div id="powerbi-prep-questions-container" class="min-h-[120px] flex flex-col items-center justify-center">
