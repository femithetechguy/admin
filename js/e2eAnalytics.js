...
window.renderE2EAnalyticsTab = function() {
  setTimeout(() => {
    fetch('json/videos/end_to_end_analystics_playlist.json')
      .then(r => r.json())
  ...
  return '<div class="w-full flex justify-center py-4"><span class="text-xl font-bold">E2E Analytics Playlist</span></div>' +
